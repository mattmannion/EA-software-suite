...
users.route('/users').get(get_all_js_1.default).post(create_one_js_1.default);
users.route('/users/:id').get(get_one_js_1.default).put(update_one_js_1.default).delete(delete_one_js_1.default);
